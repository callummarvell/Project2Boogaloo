...
getSims(two,model2)
print("++++++++")
#print(model.most_similar(positive=["castle"]))
#print(model2.most_similar(positive=["castle"]))
...
print(model.most_similar(positive=["house","city"]))
print(model2.most_similar(positive=["house","city"]))
#getSims(three)
#print("===========")
#getSims(four)
#print("===========")
